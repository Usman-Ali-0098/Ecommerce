...
type ResetPasswordFormState = Pick<
  ResetPasswordInput,
...
export default function ResetPasswordForm({ token }: ResetPasswordFormProps) {
  ...
  function updateField(field: keyof ResetPasswordFormState, value: string) {
    setForm((current) => ({
      ...current,
      [field]: value,
    }));
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!validationResult.success) {
      ...
      for (const issue of validationResult.error.issues) {
        ...
        if (
          typeof field === "string" &&
          !fieldErrors[field as keyof ResetPasswordInput]
        ) {
          fieldErrors[field as keyof ResetPasswordInput] = issue.message;
        }
      }
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        ...
        showAlert(data.message || "Unable to reset your password.", {
          variant: isExpiredOrUsed ? "warning" : "error",
      ...
      showAlert(data.message || "Your password has been reset successfully.", {
        variant: "success",
      ...
      showAlert("Unable to reset your password right now. Please try again.", {
        variant: "error",
      });
    } finally {
