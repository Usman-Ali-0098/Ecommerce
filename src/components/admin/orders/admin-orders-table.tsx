            ...
            >
              ...
              <td className="px-4 py-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="max-w-180 truncate text-xs font-medium text-gray-800">
                      {order.customer.fullName || "Customer"}
                    </p>

                    <p className="mt-0.5 max-w-50 truncate text-[11px] text-gray-400">
              ...
              <td className="px-4 py-3">
                <span className="whitespace-nowrap text-xs font-semibold text-gray-900">
                  Rs. {Math.round(order.total).toLocaleString("en-PK")}
                </span>
              </td>
